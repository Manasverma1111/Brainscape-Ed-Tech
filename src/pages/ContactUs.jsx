    ...
    <div>
        ...
        <div className='lg:w-[40%]'>
            <div className='flex flex-col gap-6 rounded-xl bg-richblack-800 p-4 lg:p-6'>
                <div className='flex flex-col gap-[2px] p-3 text-sm text-richblack-200'>
                    ...
                    <p className='font-medium'>Our friendly team is here to help you.</p>
                    <p className='font-semibold'>info@brainscape.com</p>
                </div>
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
                    ...
                    <p className='font-medium'>Say hello to our team members.</p>
                    <p className='font-semibold'>Team CodeNexus</p>
                </div>
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
                ...
                <p className='font-semibold'>+91- 11111 22222</p>
                </div>
            </div>
        </div>
        <div className='lg:w-[60%]'>
            <div className='border border-richblack-600 text-richblack-300 rounded-xl p-7 lg:p-14 flex gap-3 flex-col'>
                ...
                <p className='text-lg font-medium'>Tell us more about yourself and what you've got in mind.</p>
                <div className='mt-7'>
                    <ContactUsForm/>
                </div>
            </div>
